            ...
            <?php include "../modals/account_modal.php"; ?>
                <div class="container-fluid">
                    <div class="block-header">
                       ...
                       <button data-target="#deleteFacultyModal" data-toggle="modal" class="btn btn-danger btn-sm  waves-effect"> <i class="small material-icons">archive</i>Archive</button>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_array($q)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>'.$row['contact'].'</td>
                                                    <td>'.$row['username'].'</td>
                                                    <td><button type="button" data-target="#editFacultyModal'.$row['facultyid'].'" data-toggle="modal" class="btn btn-primary btn-sm  waves-effect"><i class="small material-icons">create</i> Edit</button></td>
                                                </tr>';
